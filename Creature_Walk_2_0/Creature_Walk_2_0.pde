...
// Celia - Jeg har ændret de adskillige int variabler til float, da det får øjene til at sidde stille
...
void draw() {  
  //Celia - Jeg har ændret i kommentaren til at de bliver en funktion
